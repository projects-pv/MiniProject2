...
def takeCommand():
    ...
    try:
        ...
        print("User said: %s\n"%query)
        if 'how are you' not in query and 'tell me about yourself' not in query and "sing for me" not in query and 'I love you' not in query:
            speak(query)
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('prakhar.bansal_cs17@gla.ac.in', '9719255972')
    server.sendmail('prakhar.bansal_cs17@gla.ac.in', to, content)
    server.close()
    ...
    # if 1:
        ...
        # Speech recognition using Google Speech Recognition
            ...
            try:
                speak("What should I say?")
                content = takeCommand()
                to = "prakhar.bansal_cs17@gla.ac.in"    
                sendEmail(to, content)
                speak("Email has been sent!")
                continue
            except Exception as e:
                print(e)
                speak("Sorry my friend harry bhai. I am not able to send this email")
	elif 'email to varsha' in query:
            try:
                speak("What should I say?")
                content = takeCommand()
                to = "varsha.kumari_cs17@gla.ac.in"    
                sendEmail(to, content)
                speak("Email has been sent!")
                continue
            except Exception as e:
            ...
            try:
                speak("What should I say?")
                content = takeCommand()
                to = "mudit.singhania_cs17@gla.ac.in"    
                sendEmail(to, content)
                speak("Email has been sent!")
                continue
            except Exception as e:
            ...
            try:
                speak("What should I say?")
                content = takeCommand()
                to = "ankur.sharma_cs17@gla.ac.in"    
                sendEmail(to, content)
                speak("Email has been sent!")
                continue
            except Exception as e:
            ...
            speak('thank you sir')
        elif 'open word' or 'open microsoft word' or 'open ms word' in query:
            speak("opening Microsoft word")
            os.startfile('C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Word.lnk')
        elif 'open excel' or 'open microsoft excel' or 'open ms excel' in query:
            speak("opening Microsoft Excel")
            os.startfile('C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Excel.lnk')
        elif 'open powerpoint' or 'open microsoft powerpoint' or 'open ms powerpoint' in query:
            speak("opening Microsoft powerpoint")
            os.startfile('C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\PowerPoint.lnk')
        elif 'open notepad' in query:
            speak("opening windows notepad")
            os.startfile('C:\\Users\\Prakhar\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Accessories\\Notepad.lnk')
